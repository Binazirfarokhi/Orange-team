                    ...
                    <ScrollView style={{ marginBottom: 30 }}>
                        ...
                        <View style={styles.list}>
                            <View style={styles.item}>
                                ...
                                <Text style={styles.itemText} onPress={() => setCollapseToggle(0)}>Personal Information</Text>
                            ...
                            <View style={styles.item}>
                                ...
                                <Text style={styles.itemText} onPress={() => setCollapseToggle(2)}>Time In Volunteer</Text>
                            ...
                            <View style={styles.item}>
                                ...
                                <Text style={styles.itemText} onPress={() => navigation.navigate('Review')}>Reviews</Text>
                                <FontAwesome name={'chevron-right'} size={20} style={styles.rightIcon} />
                            </View>
