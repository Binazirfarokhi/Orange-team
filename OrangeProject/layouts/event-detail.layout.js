...
import { DATE_FORMAT_DISPLAY, TIME_FORMAT_DISPLAY, TYPE_PARENT, TYPE_VOLUNTEER } from "../util/constants";
...
const EventDetailScreen = ({ navigation, route }) => {
    ...
    useEffect(() => {
        get(`/orgs/event/${id}`).then(event => {
            const { eventName, date, time, organization, participantsList, images, location, coordinates,
                eventType, ageGroup, participants, description, note, volunteers, participantsUserList } = event.data.data
