...
const CreateEventScreen = ({ navigation, route }) => {
    ...
    useEffect(() => {
        if (id) {
            get(`/orgs/event/${id}`).then(data => {
                const { ageGroup, date, description, eventName, eventType, location, note, organization, organizationId, participants, time, images, volunteers } = data.data.data;
    ...
    const save = () => {
        ...
        if (message !== '') {
            ...
            const data = {
                eventName, date, time, organization, location, images, organization: organizationId, eventType, ageGroup, participants, description, note, volunteers: volunteers.map(vol => vol.id)
            }
            if (id) {
