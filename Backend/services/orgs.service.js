const { getOrgs, getOrg, saveOrg, getVolunteerByOrgIdRepo, saveEventRepo, getEventList, getEventListJoined, getEventDetail, deleteEventData, joinEventRepo, getOrgsByIds } = require("../repo/org.repo");
...
module.exports = {
    orgs, org, saveNewOrg, getVolunteerByOrgId, saveEvent, getEvent, getEvents, deleteEvent, joinEvent, getJoinedEvents, getOrgsByVolunteerId
}