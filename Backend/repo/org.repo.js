const { collection, getDocs, getDoc, doc, query, setDoc, updateDoc, where, deleteDoc } = require("firebase/firestore");
...
module.exports = { getOrg, getOrgs, getVolunteerByOrgIdRepo,saveOrg, updateOrg, saveEventRepo, getEventList, getEventListJoined, getEventDetail, deleteEventData, joinEventRepo }
